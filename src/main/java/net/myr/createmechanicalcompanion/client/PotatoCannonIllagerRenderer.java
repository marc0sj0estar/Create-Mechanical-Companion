...
public class PotatoCannonIllagerRenderer extends MobRenderer<PotatoCannonIllager, IllagerModel<PotatoCannonIllager>> {
    private static final ResourceLocation POTATO_CANNON_ILLAGER_TEXTURE = ResourceLocation.fromNamespaceAndPath(CreateMechanicalCompanion.MOD_ID, "textures/entity/potato_cannon_illager.png");
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(PotatoCannonIllager entity) {
